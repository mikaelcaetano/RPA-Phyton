# Desafio quebrar um captcha de um site
# Como passar de CAPTCHA utilizando a ferramenta anti-captcha que é um serviço pago para que você possa passar deles.
# Por mais que esse serviço para quebra de CAPTCHA seja pago o valor é pequeno para cada um que você passa.
